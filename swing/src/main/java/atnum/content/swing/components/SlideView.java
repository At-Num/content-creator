...
import atnum.content.core.model.listener.ShapeListener;
...
import atnum.content.core.util.OsInfo;
import atnum.content.core.view.PageObjectView;
 ...
 * @author Alex
 */
public class SlideView extends JComponent implements atnum.content.core.view.SlideView, ShapeListener, ParameterChangeListener {
