...
import atnum.content.swing.components.previews.TeXToolPreview;
import atnum.content.swing.components.previews.TextToolPreview;
import atnum.content.swing.components.previews.ToolPreview;
...
public class ToolColorChooser extends JPanel {
	...
	public ToolColorChooser(ResourceBundle resources) {
		...
		setSelectedStroke(new Stroke(atnum.content.core.graphics.Color.BLACK, 1), true);
	}
