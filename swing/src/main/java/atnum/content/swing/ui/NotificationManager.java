...
package atnum.content.swing.ui;
...
public class NotificationManager {
	...
	private final Stack<NotificationPopup> notificationStack = new Stack<>();
	
	/** Visible notifications. */
	private final List<NotificationPopup> list = new ArrayList<>(MAX_VISIBLE_NOTIFICATIONS);
