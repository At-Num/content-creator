...
package atnum.content.presenter.api.util;
...
import atnum.content.presenter.api.presenter.command.QuitSaveDocumentsCommand;
...
public class SaveDocumentsHandler extends ShutdownHandler {
	...
	public boolean execute() throws Exception {
		PresenterConfiguration config = context
				.getConfiguration();
