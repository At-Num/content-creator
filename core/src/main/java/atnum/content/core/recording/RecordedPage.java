...
import atnum.content.core.recording.action.ActionFactory;
import atnum.content.core.recording.action.BaseStrokeAction;
import atnum.content.core.recording.action.ExtendViewAction;
import atnum.content.core.recording.action.PanningAction;
import atnum.content.core.recording.action.PlaybackAction;
import atnum.content.core.recording.action.StaticShapeAction;
import atnum.content.core.recording.action.ToolBeginAction;
import atnum.content.core.recording.action.ToolEndAction;
import atnum.content.core.recording.action.ToolExecuteAction;
